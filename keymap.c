/* Copyright 2015-2017 Janina Wibker
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_M_BASE] = LAYOUT_planck_mit(
    ...
    KC_LSFT,      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_N, KC_M,    KC_COMM, KC_DOT,      KC_SLSH,   KC_ENT,
    M_FN,         KC_LCTL, KC_LALT, KC_LGUI, M_RAISE, KC_SPC,     M_LOWER, KC_RALT, _M_CAPSLOCK, _GUI_MINS, _CTL_EQL
  ),
  ...
  [_M_ADJUST] = LAYOUT_planck_mit(
    _NUM_PS, KC_BTN1, _M_MS_UP,         KC_BTN2, KC_WH_U, KC_DEL, KC_PSLS,  KC_P1,   KC_P2,   KC_P3,    KC_PMNS, RESET,
    KC_BTN3, KC_MS_L, _M_MS_DW,         KC_MS_R, KC_WH_D, KC_TAB, KC_PAST,  KC_P4,   KC_P5,   KC_P6,    KC_PPLS, _FORWARDS,
  ...
  switch (keycode) {
    ...
    case M_FN: {
      ...
      if(record->event.pressed) {
        ...
        // turning off the layer and unregistering the key (is this potentially a bad practice?)
      }
    } break;
