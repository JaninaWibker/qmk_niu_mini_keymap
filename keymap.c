...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	[_L_BASE] = LAYOUT_planck_mit(
		...
		L_ADJUST,     KC_LCTL, KC_LGUI, KC_LALT, L_RAISE, KC_SPC,     L_LOWER, KC_RALT, KC_CAPS, _GUI_LEFT, _SFT_RIGHT),
   ...
   */
	[_M_BASE] = LAYOUT_planck_mit(
		...
		KC_LSFT,      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_N, KC_M,    KC_COMM, KC_DOT,    KC_SLSH,   KC_ENT, 
		_M_FN,        KC_LCTL, KC_LALT, KC_LGUI, M_RAISE, KC_SPC,     M_LOWER, KC_RALT, KC_CAPS, _GUI_LEFT, _SFT_RIGHT),
